...
# Title: Sig By Sig Dpsk Chal
# Generated: Thu Jan  1 18:44:29 2015
##################################################
...
class sig_by_sig_dpsk_chal(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Sig By Sig Dpsk Chal")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "./pure_signal_dpsk", False)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.digital_dxpsk_mod_0, 0))
