...
# Title: Sig By Sig Psk Chal
# Generated: Thu Jan  1 18:44:26 2015
##################################################
...
class sig_by_sig_psk_chal(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Sig By Sig Psk Chal")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "./payload2", True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "./pure_signal_psk", False)
